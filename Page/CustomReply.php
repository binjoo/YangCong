...
include 'header.php';
include 'menu.php';
include 'YangCong/Widget/Utils.php';
$currentUrl = Helper::url("YangCong/Page/CustomReply.php");
?>
<div class="main">
    <div class="body container">
        <div class="colgroup">
            <div class="typecho-page-title col-mb-12">
                <h2>自定义回复<a href="<?php _e($currentUrl) ?>">新增</a></h2>
            </div>
        </div>
        <div class="colgroup typecho-page-main manage-metas">
            <div class="col-mb-12 col-tb-8" role="main">
                <div class="typecho-list-operate clearfix">
                    ...
                    <div class="search" role="search">
                        <input type="hidden" class="text-s" value="YangCong/Page/CustomReply.php" name="panel">
                ...
                <div class="typecho-table-wrap">
                    <table class="typecho-list-table">
                        ...
                        <tbody>
                            <?php Typecho_Widget::widget('YangCong_Widget_CustomReply')->to($customreply); ?>
                            <?php if($customreply->have()): ?>
                                <?php while ($customreply->next()): ?>
                                    <tr id="rid-customreply-<?php $customreply->rid(); ?>">
                                        ...
                                        <td>
                                            <a href="<?php _e(Helper::url('YangCong/Page/CustomReply.php').'&page='.$customreply->getCurrentPage().'&rid='.$customreply->rid) ?>"><?php $customreply->keywords(); ?></a>
                                        </td>
            ...
            <div class="col-mb-12 col-tb-4" role="form">
                <?php Typecho_Widget::widget('YangCong_Widget_CustomReply')->form()->render(); ?>
            </div>
        </div>
    </div>
</div>
